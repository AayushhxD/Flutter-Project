...
import 'package:pet_care_shop/View/buttons.dart';
import 'package:pet_care_shop/View/grooming.dart';
import 'package:pet_care_shop/View/notification.dart';
import 'package:pet_care_shop/View/shop.dart';
import 'package:pet_care_shop/View/training.dart';
import 'package:pet_care_shop/View/veterinary.dart';
...
class _DashboardState extends State {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: const Color.fromARGB(255, 249, 253, 253),
      body: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: const BoxDecoration(
                          image: DecorationImage(
                              image: AssetImage("assets/images/dash2.png"),
                              fit: BoxFit.fill)),
                    )
                  ],
                ),
                    ...
                    children: [
                      GestureDetector(
                        child: Container(
                          ...
                          decoration: const BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage("assets/images/category4.png"),
                            ),
                          ),
                        ),
                        onTap: () {
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: const BoxDecoration(
                          image: DecorationImage(
                              image: AssetImage("assets/images/dashevent.png"),
                              fit: BoxFit.fill)),
                    )
                  ],
                ),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: const BoxDecoration(
                          image: DecorationImage(
                              image: AssetImage(
                                  "assets/images/dash community.png"),
                              fit: BoxFit.fill)),
                    )
                  ],
                ),
